    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                ...
                actionUrl = editor.getOpt('imageFormUrl'),
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                data['key'] += Number(new Date()) + Math.random().toString(36).substr(9) + '.' + file.file.ext;
                _this.fileKeyList[file.blob.ruid] = data['key'];
                // console.log('uploadBeforeSend', file, data, header);
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                var filename = _this.fileKeyList[ruid];
                var $file = $('#' + file.id);
